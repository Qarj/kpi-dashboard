...
def _get_data_for_kpi(request, kpi, view_type, report_period_days, url_from_date, url_to_date):
    ...
    dashboard_status, dash_report_period_days, dash_report_suite_id, metric_id, kpi_label = _get_dashboard_definition(kpi)
...
def _get_dashboard_definition(kpi):
    try:
        ...
        return 'No dashboard with name ' + kpi + ' found, assuming it is a metric_id', None, None, None, None
